...
import me.capitainecat0.multicommands.commands.implementers.MultiHelp;
...
public class MultiHelpCMD implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            new MultiHelp((Player) sender).execute();
