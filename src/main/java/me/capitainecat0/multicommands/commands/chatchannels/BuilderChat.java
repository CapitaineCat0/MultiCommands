...
public class BuilderChat implements CommandExecutor, Listener {
    ...
    /**
     * La commande &quot;/builderchat&quot; requiert la permission &quot;multicommands.builderchat&quot; pour fonctionner.
     * Cette commande permet de parler avec les joueurs
     * <br>ayant la permission &quot;multicommands.builderchat&quot;
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String @NotNull [] args) {
        ...
        if (args.length >= 1) {
            try {
                ...
                boolean hasPermission = MultiCommands.getPermissions().has((Player) sender, Perms.BUILDERCHAT_PERM.getPermission()) || MultiCommands.getPermissions().has((Player) sender, ALL_CHAT_PERM.getPermission()) || MultiCommands.getPermissions().has((Player) sender, ALL_PERMS.getPermission());
